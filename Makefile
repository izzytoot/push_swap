...
#    Updated: 2025/01/03 18:49:28 by icunha-t         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = c_push.c c_reverse_rotate.c c_rotate.c c_swap.c error_handling.c mini_sort.c split.c stack_init.c pivot_and_partitioning.c sorting_alg.c utils_sort.c utils_stack.c
